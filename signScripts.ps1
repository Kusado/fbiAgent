$cert = Get-ChildItem -Path "Cert:\CurrentUser\My" | Where-Object {$_.Thumbprint -eq "126E196BD8C229879CF8A3588586F513FDFFB8AA"}

$scripts = Get-ChildItem -Path \\fenix\Distrib\Zabbix\fbiAgent -Filter *.ps1 -Recurse
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUoTGI4KuHHUdDSWeEp3mD4+1f
# 6QGgggZfMIIGWzCCBEOgAwIBAgITHAAAABfTJzYopHkkRwAAAAAAFzANBgkqhkiG
...
# CzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOI5X2yqxh3DFTJjLp7A
# 4NAaTJwUMA0GCSqGSIb3DQEBAQUABIGAqNAm3uu43JkIYImixZPgT9/5LjBmZWOo
# ZJd09jWv6pMJxY+1Jd33vqvExJ1VPzfyevmUFuEuw6+sfn58vyU3eyuVPXbKe+yV
# O72FspQaVPpxRBSAQ/2/RoeZsv8lqTcEzTY8n3EqDVdocG6nUkwTWs+sV9MQuwn+
# 4bwiL/T7R9M=
